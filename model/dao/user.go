...
type UserDao interface {
	...
	ListUserInfo(ctx context.Context,limit, conds map[string]interface{}) ([]*domain.UserInfo,error)
	CountUserInfo(ctx context.Context,conds map[string]interface{}) (int64,error)
}
